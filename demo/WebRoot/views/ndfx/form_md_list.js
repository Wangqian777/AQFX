$(function(){
	...
	$("#btntable-add").click(function(){
		...
		openFormCard("form_md.html","新增年度风险");
	});
	$("#btntable-edit").click(function(){
		...
		localStorage.ndfxId=dataArray[0].ID;
		localStorage.FormMode="Edit";
		openFormCard("form_md.html","编辑年度风险");
	});
	$("#btntable-delete").click(function(){
		...
		layer.confirm('确认删除吗？', {  
	    	...
	    	layer.close(index);
	    	var json={"zhubiao":"风险清单","zhubiaoID":localStorage.ndfxId};
	    	FormAction(json,"D");
	    }); 
	});
	$("#btntable-view").click(function(){
		...
		openFormCard("form_md.html","查看年度风险");
	});

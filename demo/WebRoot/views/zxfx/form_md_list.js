$(function(){
	...
	$("#btntable-add").click(function(){
		...
		openFormCard("form_md.html","新增专项风险");
	});
	$("#btntable-edit").click(function(){
		...
		localStorage.zxfxId=dataArray[0].ID;
		localStorage.FormMode="Edit";
		openFormCard("form_md.html","编辑专项风险");
	});
	$("#btntable-delete").click(function(){
		...
		layer.confirm('确认删除吗？', {  
	    	...
	    	layer.close(index);
	    	var json={"zhubiao":"风险清单","zhubiaoID":localStorage.zxfxId};
	    	FormAction(json,"D");
	    }); 
	});
	$("#btntable-view").click(function(){
		...
		openFormCard("form_md.html","查看专项风险");
	});
